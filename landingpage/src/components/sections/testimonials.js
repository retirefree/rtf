                  ...
                  <div className="testimony-wrap py-4">
                    <div className="text">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="pl-3">
                          <p className="name">Aubrey Smith</p>
                          <span className="position">Retired, New Jersey</span>
                        </div>
                      </div>
                      </div>
                    </div>
                  ...
                  <div className="testimony-wrap py-4">
                    <div className="text">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="pl-3">
                          <p className="name">Robin Campbell</p>
                          <span className="position">Teacher, California</span>
                        </div>
                      </div>
                      </div>
                    </div>
                  ...
                  <div className="testimony-wrap py-4">
                    <div className="text">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="pl-3">
                          <p className="name">Steven Mark</p>
                          <span className="position">Artist, New York</span>
                        </div>
                        </div>
                      </div>
                    </div>
